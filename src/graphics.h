...
struct Graphics {
    ...
    SDL_Texture* loadTextTexture( std::string path, SDL_Color textColor, TTF_Font* textfont){
        SDL_Surface* loadedSurface = TTF_RenderText_Solid(textfont, path.c_str(), textColor);
